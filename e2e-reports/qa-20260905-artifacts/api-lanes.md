...
Worktree: <qa-worktree>/lane05
Commit: 4a78ff7
Database retained: qa_20260905_lane05, Postgres socket /tmp, role snow.
...
HTTP artifacts: <run-temp>/qa-20260905-lane05-http.mjs and <run-temp>/qa-20260905-lane05-http.json.
Health artifact from first run: <run-temp>/qa-20260905-lane05-health.json.
Servers96559 and3568 stopped by exact handles; HTTP53298 exited0. No active services remain.

## Lane09 — E2E-010

Worktree: <qa-worktree>/lane09
Database retained: qa_20260905_lane09, Postgres socket /tmp, role snow.
...
HTTP artifacts: <run-temp>/qa-20260905-lane09-http.mjs and <run-temp>/qa-20260905-lane09-http.json. Before GraphQL body artifact: <run-temp>/qa-20260905-lane09-graphql-before-body.txt (empty response, status500 recorded in execution).
