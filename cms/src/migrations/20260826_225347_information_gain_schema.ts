...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "articles" DROP CONSTRAINT "articles_research_snapshot_id_corpus_snapshots_id_fk";
  
  ALTER TABLE "articles" DROP CONSTRAINT "articles_information_gain_run_id_information_gain_runs_id_fk";
  
  ALTER TABLE "governance_audit_rels" DROP CONSTRAINT "governance_audit_rels_evidence_sources_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_evidence_sources_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_evidence_source_candidates_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_corpus_snapshots_fk";
  
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_information_gain_runs_fk";
  ...
  DROP INDEX "articles_research_research_snapshot_idx";
  DROP INDEX "articles_information_gain_information_gain_run_idx";
  DROP INDEX "governance_audit_subject_global_idx";
  DROP INDEX "governance_audit_rels_evidence_sources_id_idx";
  DROP INDEX "payload_locked_documents_rels_evidence_sources_id_idx";
  DROP INDEX "payload_locked_documents_rels_evidence_source_candidates_idx";
  DROP INDEX "payload_locked_documents_rels_corpus_snapshots_id_idx";
  DROP INDEX "payload_locked_documents_rels_information_gain_runs_id_idx";
  ALTER TABLE "articles" DROP COLUMN "research_snapshot_id";
  ALTER TABLE "articles" DROP COLUMN "research_query_cluster";
  ALTER TABLE "articles" DROP COLUMN "research_facets";
  ALTER TABLE "articles" DROP COLUMN "research_gaps";
  ALTER TABLE "articles" DROP COLUMN "information_gain_run_id";
  ALTER TABLE "articles" DROP COLUMN "information_gain_decision";
  ALTER TABLE "articles" DROP COLUMN "information_gain_policy_version";
  ALTER TABLE "articles" DROP COLUMN "information_gain_consensus_coverage";
  ALTER TABLE "articles" DROP COLUMN "information_gain_verified_gain_units";
  ALTER TABLE "articles" DROP COLUMN "information_gain_verification_ratio";
  ALTER TABLE "articles" DROP COLUMN "information_gain_internal_duplication_rate";
  ALTER TABLE "articles" DROP COLUMN "information_gain_verified_novel_claims";
  ALTER TABLE "articles" DROP COLUMN "information_gain_scored_at";
  ALTER TABLE "articles" DROP COLUMN "review_justification";
  ALTER TABLE "articles" DROP COLUMN "revision_notes";
  ALTER TABLE "articles" DROP COLUMN "revision_count";
  ALTER TABLE "governance_audit" DROP COLUMN "subject_global";
  ALTER TABLE "governance_audit_rels" DROP COLUMN "evidence_sources_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "evidence_sources_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "evidence_source_candidates_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "corpus_snapshots_id";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "information_gain_runs_id";
  ALTER TABLE "llm_settings" DROP COLUMN "claim_extraction_model";
  ALTER TABLE "llm_settings" DROP COLUMN "information_gain_judge_model";
  ALTER TABLE "llm_settings" DROP COLUMN "evidence_verification_model";
  DROP TYPE "public"."enum_articles_information_gain_decision";
  DROP TYPE "public"."enum_evidence_sources_quality_class";
  DROP TYPE "public"."enum_evidence_source_candidates_status";
  DROP TYPE "public"."enum_evidence_source_candidates_suggested_class";
  DROP TYPE "public"."enum_corpus_snapshots_pages_fetch_status";
  DROP TYPE "public"."enum_corpus_snapshots_status";
  DROP TYPE "public"."enum_information_gain_runs_decision";
  DROP TYPE "public"."enum_llm_settings_claim_extraction_model";
  DROP TYPE "public"."enum_llm_settings_information_gain_judge_model";
  DROP TYPE "public"."enum_llm_settings_evidence_verification_model";
  DROP TYPE "public"."enum_information_gain_policy_require_exact_value_match";
  DROP TYPE "public"."enum_information_gain_policy_require_evidence_lineage";
  DROP TYPE "public"."enum_information_gain_policy_block_first_party_measurements";`)
}
